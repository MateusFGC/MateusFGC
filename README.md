...
| :--- | :--- |
| **💻 Desenvolvimento Front-End** | `HTML5 (Semântico)` `CSS3 (Flexbox, Grid)` `JavaScript` `Bootstrap` `Design Responsivo` `Acessibilidade Web` |
| **🚀 Plataformas & Ferramentas** | `WordPress` `Canva` `GitHub` `Photoshop` |
| **📈 Performance & SEO** | `SEO On-Page` `Otimização de Conversão` `Análise de Performance` `Core Web Vitals` |
